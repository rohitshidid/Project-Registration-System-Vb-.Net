...
no_error:
        ...
        If TextBox4.Text IsNot "" And TextBox3.Text IsNot "" And TextBox4.Text.Length = 6 And TextBox3.Text.Length = 10 And i < 1 Then
            ...
            comm.CommandText = "Insert into sem6 ([Name of the project],[Subject],[Nos of teammates],[Roll no(L)],[Phone no (L)],[Roll no(t1)],[Phone no (t1)],[Roll no(t2)],[Phone no (t2)],[Roll no(t3)],[Phone no (t3)],[Roll no(t4)],[Phone no (t4)],[Roll no(t5)],[Phone no (t5)],[Description]  ) VALUES ('" & sem6.TextBox1.Text & "','" & sem6.ComboBox1.Text & "','" & Me.NumericUpDown1.Text & "','" & Me.TextBox4.Text & "','" & Me.TextBox3.Text & "','" & Me.TextBox1.Text & "','" & Me.TextBox5.Text & "','" & Me.TextBox6.Text & "','" & Me.TextBox7.Text & "','" & Me.TextBox8.Text & "','" & Me.TextBox9.Text & "','" & Me.TextBox2.Text & "','" & Me.TextBox10.Text & "','" & Me.TextBox11.Text & "','" & Me.TextBox12.Text & "','" & Me.TextBox13.Text & "')"
    ...
    Private Sub additional_info6_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub RD()
        Dim da As New OleDbDataAdapter("SELECT *  FROM sem6", conn)
        Dim dt As New DataTable()

        da.Fill(dt)

        view_list6.DataGridView1.DataSource = dt
